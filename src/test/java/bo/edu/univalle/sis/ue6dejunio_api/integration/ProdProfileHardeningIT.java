...
/**
 * Spec: Production hardening (P2) — swagger disabled, error bodies omit message/binding detail
 * when the `prod` profile is layered on top of the `it` datasource profile.
 */
