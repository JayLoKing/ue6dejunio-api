...
class CatalogServiceTest {
    ...
    void trimesters_explicitYear_returnsMappedItemsOrderedByTrimester() {
        ...
        List<TrimesterPeriod> periods =
                List.of(
                        new TrimesterPeriod(
                                id1, 5, 1, LocalDate.of(2026, 2, 1), LocalDate.of(2026, 5, 31)),
                        new TrimesterPeriod(
                                id2, 5, 2, LocalDate.of(2026, 6, 1), LocalDate.of(2026, 8, 31)));
        ...
        assertThat(result)
                .containsExactly(
                        new TrimesterPeriodItem(
                                id1, 1, LocalDate.of(2026, 2, 1), LocalDate.of(2026, 5, 31)),
                        new TrimesterPeriodItem(
                                id2, 2, LocalDate.of(2026, 6, 1), LocalDate.of(2026, 8, 31)));
