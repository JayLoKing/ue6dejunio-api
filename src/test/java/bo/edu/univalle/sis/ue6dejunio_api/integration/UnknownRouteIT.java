...
/**
 * Spec: the catch-all exception handler must not turn Spring's own web exceptions into 500. A path
 * with no handler is a client error, not an outage — before this was pinned down, every unmapped
 * URL answered 500 and hid real server failures in the same bucket.
 */
