 ...
 *
 * <p>Requires Docker/Testcontainers; not executable in the implementation sandbox for this
 * change. Because the sandbox could not run this test, "constant query count" is UNVERIFIED here
 * — only asserted by static code review of {@code GradebookService} (batch query moved outside
 * the per-row map/loop). See the apply-progress report.
 */
