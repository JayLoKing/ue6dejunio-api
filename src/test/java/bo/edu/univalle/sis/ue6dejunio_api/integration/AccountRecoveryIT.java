...
/**
 * Spec: RF3 stateless, single-use, email-based password reset. Docker-gated via {@link
 * AbstractIntegrationTest} (Testcontainers disabledWithoutDocker=true).
 */
class AccountRecoveryIT extends AbstractIntegrationTest {
    ...
    void resetPassword_reusedToken_returns400AndPasswordUnchangedOnSecondUse() throws Exception {
        ...
        org.assertj.core.api.Assertions.assertThat(currentStoredHash())
                .isEqualTo(hashAfterFirstReset);
    }
