 ...
 *     them for a homeroom teacher. Capped because no course carries thirty active subjects, and an
 *     authenticated write should not be able to post a list without end.
 */
public record CreatePdcRequest(
        ...
        @NotNull @JsonFormat(pattern = "yyyy-MM-dd") @JsonProperty("period_start")
                LocalDate periodStart,
        @NotNull @JsonFormat(pattern = "yyyy-MM-dd") @JsonProperty("period_end")
                LocalDate periodEnd,
