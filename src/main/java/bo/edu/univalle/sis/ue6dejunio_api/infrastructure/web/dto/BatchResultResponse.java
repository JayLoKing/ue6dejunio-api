...
/**
 * Outcome of a whole-group attendance write: how many marks arrived and how many rows were actually
 * persisted, which differ when the same enrollment is sent twice.
 */
