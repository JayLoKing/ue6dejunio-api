 ...
 * @param average the mean of the trimesters this area was actually graded in. A subject that starts
 *     mid-year is averaged over the trimesters it existed for, never over three — dividing by three
 *     would invent failed trimesters for a course the student never had.
 */
