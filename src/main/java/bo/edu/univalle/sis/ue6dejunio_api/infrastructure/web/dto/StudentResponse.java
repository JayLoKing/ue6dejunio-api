...
public record StudentResponse(
    ...
    public static StudentResponse from(Student s) {
        return new StudentResponse(
            ...
            s.getBirthDate(), s.getGender(), s.getStatus(), s.getStatusReason(),
            s.getStatusNote(), s.getStatusChangedAt(), s.getStatusChangedById(),
            s.getStatusChangedByName(), s.getCreatedAt()
        );
    }
}
