 ...
 * never wrote down, and dropping them from the total would make the report disagree with the
 * roster the same screen shows.
 *
 * @param percentage share of the effective roster, two decimals, or null when there is no
 *                   effective roster to be a share of. A zero there would read as "nobody passed"
 *                   on a course that has no students at all.
 */
