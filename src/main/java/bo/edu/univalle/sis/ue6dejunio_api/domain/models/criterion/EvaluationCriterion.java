 ...
 * directly on the criterion ({@code activityName == null}) or derived from the average of the items
 * of the activity that produced it ({@code activityName != null}). A criterion never mixes both:
 * see {@code chk_score_target} on {@code assessment_scores}.
 */
