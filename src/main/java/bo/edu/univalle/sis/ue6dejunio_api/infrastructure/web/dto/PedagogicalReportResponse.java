...
public record PedagogicalReportResponse(
     ...
     * neither passed nor failed, and {@code male + female} can fall under {@code total} because a
     * student's gender may not be on record.
     */
    ...
    public static PedagogicalReportResponse from(PedagogicalReportSheet sheet) {
        List<FailingStudent> failing =
                sheet.failingStudents().stream()
                        .map(
                                row ->
                                        new FailingStudent(
                                                row.number(),
                        ...
                        .toList();
        return new PedagogicalReportResponse(
                sheet.courseId(),
                sheet.gradeName(),
                sheet.parallelName(),
                sheet.year(),
                sheet.homeroomTeacherName(),
                sheet.trimester(),
                sheet.exists(),
                sheet.achievements(),
                sheet.difficulties(),
                new Stats(
                        tally(sheet.stats().effective()),
                        tally(sheet.stats().passed()),
