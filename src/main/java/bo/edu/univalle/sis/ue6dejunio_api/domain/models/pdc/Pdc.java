 ...
 * course; which subjects it covers is said by {@link #subjects}, so a homeroom teacher's plan and a
 * specialist's plan are the same shape with a different number of blocks.
 */
@Data
...
public class Pdc {
     ...
     */
    @Builder.Default private List<PdcSubject> subjects = List.of();
     ...
     */
    @Builder.Default private int areaCount = 0;

    @Builder.Default private int significantAdaptationCount = 0;
