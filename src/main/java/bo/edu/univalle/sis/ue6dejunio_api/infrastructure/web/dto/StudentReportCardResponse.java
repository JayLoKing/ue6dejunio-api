...
public record StudentReportCardResponse(
    ...
    /**
     * Areas passed and failed that trimester. They need not add up: an area with no mark is counted
     * in neither.
     */
    ...
    public static StudentReportCardResponse from(StudentReportCard c) {
        ...
        List<BigDecimal> averages =
                Arrays.asList(c.trimester1Average(), c.trimester2Average(), c.trimester3Average());
