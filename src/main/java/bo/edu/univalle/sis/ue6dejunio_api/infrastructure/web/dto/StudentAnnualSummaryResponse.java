...
public record StudentAnnualSummaryResponse(
    ...
    /**
     * A null trimester means the area has no row there; {@code average} covers only the trimesters
     * it was graded in.
     */
    ...
    public static StudentAnnualSummaryResponse from(StudentAnnualSummary s) {
        ...
        List<BigDecimal> averages =
                Arrays.asList(s.trimester1Average(), s.trimester2Average(), s.trimester3Average());
        return new StudentAnnualSummaryResponse(
