 ...
 * back to it. One roll call therefore changes what the model would say about nine subjects, not one.
 */
public record DailyAttendanceRecorded(List<UUID> courseEnrollmentIds, LocalDate date)
    ...
    public DailyAttendanceRecorded {
        ...
        courseEnrollmentIds = courseEnrollmentIds == null
            ? List.of()
            : List.copyOf(courseEnrollmentIds);
