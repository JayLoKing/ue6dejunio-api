 ...
 *
 * <p>The school's heading — district, department, dependency, shift — is deliberately absent. It
 * is the same on every libreta ever printed and is read once from {@code /api/institution}; copying
 * it into every student's payload would be sending the same eight strings back for each of thirty
 * children.
 *
 ...
 * @param fields               the fields of knowledge in sheet order, each with its areas. A field
 *                             the student has no marked area in is left out.
