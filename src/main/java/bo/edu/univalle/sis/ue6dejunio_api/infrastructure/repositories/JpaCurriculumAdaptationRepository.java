...
public interface JpaCurriculumAdaptationRepository
        extends JpaRepository<CurriculumAdaptationEntity, UUID> {
    ...
    /**
     * How many significant adaptations each of these plans holds, asked for a whole page at once. A
     * plan with none is absent from the result, which reads as zero.
     */
    @Query(
            """
