 ...
 *     exists for a reason the list does not have and therefore has to say what it was; optional
 *     beside the named ones, where it adds detail rather than the reason itself
...
public record WithdrawStudentCommand(
        UUID studentId, StudentWithdrawalReason reason, String note, UUID actorId) {}
