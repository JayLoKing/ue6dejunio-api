 ...
 *                           this import. Reported on its own because it is a change to somebody the
 *                           import did not create, and the school should see that it happened
 */
public record EnrollResponse(
    ...
    public static EnrollResponse from(EnrollResult r) {
        return new EnrollResponse(r.studentsTotal(), r.studentsCreated(), r.studentsExisting(),
            r.studentsReadmitted(), r.enrollmentsCreated(), r.enrollmentsSkipped());
    }
}
