 ...
 *                       true of one year, so a listing that spans them all shows the same student
 *                       once per enrolment. Resolved to the current gestión by the application when
 *                       the caller names neither this nor a course
