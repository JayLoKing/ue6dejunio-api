...
public class NotificationService implements INotificationService {
    ...
    /**
     * Who answers to the Director. The role names are the ones the seed writes and {@code
     * AuthorizationComponent} reads.
     */
    ...
    public NotificationService(
            INotificationDomain notificationDomain, IDomainEventPublisher events) {
     ...
     *
     * <p>Marked {@code readOnly} this threw "cannot execute UPDATE in a read-only transaction" — a
     * write annotation on the adapter does not lift the restriction, because the adapter joins the
     * transaction this method already opened rather than starting one of its own.
     */
    @Override
    @Transactional
