 ...
 *                  what the model answers and what the column stores, so the web reads one
 *                  vocabulary for these four categories instead of three.
 * @param pFail     probability of failing. Kept apart from {@code pOutstanding} because the school
 *                  reads two opposite questions off the same four class probabilities, and one
 *                  collapsed score would name neither.
 */
