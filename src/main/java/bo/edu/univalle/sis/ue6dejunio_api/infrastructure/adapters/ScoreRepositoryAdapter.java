...
public class ScoreRepositoryAdapter implements IScoreDomain {
    ...
    public ScoreRepositoryAdapter(
            JpaAcademicScoreRepository scoreRepo,
    ...
    @Override
    @Transactional
    public UUID ensureAcademicScore(
            UUID courseEnrollmentId, UUID classGroupId, Integer trimester, UUID createdBy) {
        AcademicScoreEntity e =
                scoreRepo
                        .findByCourseEnrollment_IdAndClassGroup_IdAndTrimester(
    ...
    public void setDimensions(
        ...
        AcademicScoreEntity e =
                scoreRepo
                        .findById(academicScoreId)
                        .orElseThrow(
                                () ->
                                        new ResourceNotFoundException(
                                                "AcademicScore", academicScoreId));
    ...
    @Override
    public Optional<AcademicScore> find(
    ...
    private AcademicScore toDomain(AcademicScoreEntity e) {
        String subject =
                e.getClassGroup() != null && e.getClassGroup().getSubject() != null
