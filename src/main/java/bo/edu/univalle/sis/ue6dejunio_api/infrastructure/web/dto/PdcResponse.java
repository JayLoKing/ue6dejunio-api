...
public record PdcResponse(
        ...
        int areaCount,
        int significantAdaptationCount,
        Integer planNumber,
        Integer trimester,
    ...
    public static PdcResponse from(Pdc p) {
        return new PdcResponse(
                ...
                p.getParallelName(),
                p.getLevelName(),
                p.getHomeroomTeacherId(),
                p.getHomeroomTeacherName(),
                p.getAreaCount(),
                p.getSignificantAdaptationCount(),
                p.getPlanNumber(),
                p.getTrimester(),
                p.getPeriodStart(),
                p.getPeriodEnd(),
                p.getStatus(),
                p.getReviewObservations(),
                p.getHolisticObjective(),
                p.getFinalProduct(),
                p.getBibliography(),
                p.getSourcePlanId(),
