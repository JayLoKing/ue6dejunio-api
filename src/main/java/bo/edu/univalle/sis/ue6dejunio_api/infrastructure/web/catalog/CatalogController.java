...
public class CatalogController {
    ...
    @Operation(
            summary =
                    "Listar materias activas. technical opcional: true=tecnicas, false=no tecnicas")
    ...
    @Operation(
            summary =
                    "Listar docentes activos. technical opcional: true=tecnicos, false=no tecnicos")
    ...
    @Operation(
            summary =
                    "Listar trimestres configurados de un anio academico. "
