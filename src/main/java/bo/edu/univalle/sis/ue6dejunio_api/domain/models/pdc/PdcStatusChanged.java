 ...
 *
 * <p>Carries what a reader needs rather than an id to go and fetch: whoever handles this runs
 * after the transaction committed, and re-reading the plan there would be a second query for
 * facts that were already in hand.
 *
