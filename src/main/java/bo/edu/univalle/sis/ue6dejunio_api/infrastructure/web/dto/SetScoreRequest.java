 ...
 *
 * @param score a coarse ceiling only. The real cap is per dimension (Being 10, Knowing 45, Doing
 *     40, Deciding 5) and cannot be known until the target is resolved, so the service still owns
 *     the exact check; this keeps an absurd payload from reaching it.
 */
