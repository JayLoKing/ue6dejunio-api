 ...
 * {@code verificationSource} are the teacher's own two columns, carried over from the stored report
 * and null until they write them.
 *
 * @param number the line number the sheet prints, from one. Assigned after the rows are ordered, so
 *     it names a place on this document rather than anything about the student.
 */
