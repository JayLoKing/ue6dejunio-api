 ...
 *
 * <p>Read is a stamp rather than a flag, and there is no boolean beside it: two columns holding
 * one fact drift the first time a write updates one and forgets the other.
 */
