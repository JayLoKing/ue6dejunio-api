 ...
 *     Counted apart from {@code studentsExisting} because it is the one number in here that reports
 *     a change to a student the import did not create, and a school re-registering someone should
