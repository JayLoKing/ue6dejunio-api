 ...
 *
 * <p>Keeping the translation here is what lets the ports stay free of {@code Page} and {@code
 * Pageable}: the adapter speaks both languages, nothing above it has to.
 */
