 ...
 * configuration, because none of it varies by course, student or year, and a column for it would
 * be a column with one value in it forever. The Director is a person who holds a role and changes,
 * so it is read from the users. Absent when nobody holds the role, the way the paper form leaves
 * the line blank.
 *
